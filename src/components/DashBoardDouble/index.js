...
const Dashboard = (props) => {
  ...
  const [reports2, setReports2] = useState(props.reports2);
...
Dashboard.propTypes = {
  ...
  reports2: PropTypes.arrayOf(PropTypes.shape({
    title: PropTypes.string,
    imgUrl: PropTypes.string,
    value: PropTypes.string,
    action: PropTypes.func,
